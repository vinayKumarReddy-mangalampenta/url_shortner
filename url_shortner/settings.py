...
SECRET_KEY = 'django-insecure-535=q_wp7w7*j+0)7pbjj_wtf^#v0w58vj%c=w-wh6r%f15!fi'
...
CSRF_TRUSTED_ORIGINS = ['https://urlshortner.up.railway.app/','https://*.127.0.0.1','https://*.railway.app','*']
